...
fprintf(1, '{ \"status\": %d, \"options\": \"-n %d -g %d\", \"time\": %f, \"output\": { \"aligned_seq_1\": %d, \"aligned_seq_2\": %d } }\n', 1, input_seq_1_size, penalty, elapsedTime, fletcherSum(aligned_seq_1), fletcherSum(aligned_seq_2));
end
